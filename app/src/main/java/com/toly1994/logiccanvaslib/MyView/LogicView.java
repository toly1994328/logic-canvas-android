...
//                .R(100f)
//                .r(50f)
//                .p(pos.formAll(200, -100)));//位移X,Y

//        painter.draw(new ShapeStar()
//                .num(5)
//                .R(100f)
//                .r(50f)
//                .coo(pos.formAll(600, 200))//设置坐标系
//        );
...
//        //绘制坐标系
        CanvasUtils.drawCoord(mContext, pos.clone(600, 200),  50, canvas);
    }
}
